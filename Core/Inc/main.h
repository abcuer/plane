...
#define FLOW_TX_Pin GPIO_PIN_9
#define FLOW_TX_GPIO_Port GPIOA
#define FLOW_RX_Pin GPIO_PIN_10
#define FLOW_RX_GPIO_Port GPIOA
#define bLED1_Pin GPIO_PIN_3
#define bLED1_GPIO_Port GPIOB
#define SCL_Pin GPIO_PIN_6
#define SCL_GPIO_Port GPIOB
#define SDA_Pin GPIO_PIN_7
#define SDA_GPIO_Port GPIOB
#define bLED2_Pin GPIO_PIN_8
#define bLED2_GPIO_Port GPIOB
#define rLED1_Pin GPIO_PIN_9
#define rLED1_GPIO_Port GPIOB
